let template = `<div style="padding-inline: 2rem; font-size: 1.5rem;"><h1>孩子沉迷{device}，真相竟然是...</h1>
...
小{family_name}说道，他的同学每个人都有两三款{kind}，他们没有未成年识别，没有防沉迷机制，没有消费限制，甚至不用实名注册都能使用，很多用户会把一整天的时间投入其中,对青少年的负面影响不可估量。目前,我社正准备与{family_name}女士一同将此家软件的开发商举报，以响应国家的防沉迷号召，为青少年创造一个更好的成长环境。</div>`;
doOnLoaded(function() {
    /**
     * @type {HTMLElement}
     */
